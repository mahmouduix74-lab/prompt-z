...
/**
 * The "thinking" character, peeking above the whole prompt console frame on
 * a loop. It sits on the reading-direction side: right for Arabic, left for
 * English — and faces inward toward the frame (the artwork's own
 * laptop/focus side reads right by default, so Arabic mirrors it to face
 * left instead).
 *
